             ...
             $result_set=mysqli_query($obj->conn,$sql) or die(mysqli_connect_error($sql));
              while($row=mysqli_fetch_array($result_set)){
                ?>
                 ...
                 <div class="py-5"><hr>
                   <a href="../data/s_delete.php?id=<?php echo $row['id'] ?>" class="text-danger mx-3 h5 float-left">Delete</a>
                        ...
                        <div id="collapse<?php echo $counter ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                          <div class="">
                            <div class="alert alert-success" role="alert">
                              <form class="row" action="../data/s_reply.php?idno=<?php echo $idno ?>&amp msg_id=<?php echo $row['id'] ?>" method="post">
