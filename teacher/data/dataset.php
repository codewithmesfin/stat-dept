      ...
      if(isset($_POST['dataset']))
        {
          ...
          if(move_uploaded_file($this->fileloc,$this->folder.$this->finalfile))
	         {
             $sql="INSERT INTO `dataset` (`dataname`, `author`, `program`, `filename`, `filetype`,
               `filesize`, `uploader_id`, `date`, `descryption`)
               VALUES ('$this->dataname', '$this->author', '$this->program', '$this->finalfile', '$this->filetype',
