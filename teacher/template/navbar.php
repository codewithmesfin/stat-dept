  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto w-100 justify-content nav-fill navs">
        ...
        <li class="nav-item">
          <a class="nav-link page-scroll" href="post.php">
            <img src="../images/post.jpg" alt="" class="rounded-circle">
              New Post
          </a>
        </li>
        <li class="nav-item">
                    ...
                    class MsgCount
                    {
                      function msgCount()
                      {
                       ...
                       $no_rows = mysqli_num_rows($result_set);
                        if($no_rows>=1){
                          ?>
                          <sup class="badge rounded-circle" style="background-color:red"><?php echo $no_rows ?></sup>
                          <?php
                       }
                      }
                    }
