<div class="container card">
  <div class="row">
    ...
    <div class="col-12 col-lg-9 mx-auto">
      <div class="row">
        <div class="col-12">
          <p class="text-center text-info h3 my-3">Researches</p><hr>
        </div>
        <?php
              class App
              {
                function app()
                {
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST"){
                    $search=$_POST["item"];
                    global $obj;
                    $sql0="SELECT * FROM research  WHERE name LIKE '%$search%'";
                    ...
                    while($row=mysqli_fetch_array($result_set0))
                      {
                        ...
                        <div class="col-6 col-lg-3">
                          <div class="card card-body">
                            <a href="../resource/research/<?php echo $row['filename'] ?>">
                              <p class="h5 text-info"><img src="../images/res/research.png" alt="" class="img-fluid" style="width:20px">
                              <?php echo $row['name'] ?></p>
                            </a>
                            <p>Author: <?php echo $row['author'] ?></p>
                            <p>Proposed for: <?php echo $row['program'] ?> Students</p>
                            <a href="../download/research.php?file=<?php echo $row['filename'] ?>">
                              <p>
